...
John Halley Gotway, Tara Jensen} % Author(s)
...
% \begin{block}{Example Configuration File}
...
\begin{block}{}
\begin{figure}
\includegraphics[width=1.0\linewidth]{../plots/out_mean.pdf}
\end{figure}
\begin{figure}
\includegraphics[width=1.0\linewidth]{../plots/out_std.pdf}
\end{figure}
\end{block}
